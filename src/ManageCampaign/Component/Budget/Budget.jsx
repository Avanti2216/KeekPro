...
const Budget = () => {
  ...
  const[offering,setOffering] = useState("PAYMENT");
  const[paymentType,setPaymentType] = useState("NEGOTIABLE")
  const[isReelSelected,setReel] = useState(false)
  const[isImageSelected,setImage] = useState(false);
  const[isStorySelected,setStory] = useState(false)
      ...
      <div className="hero-section">
        ...
        <div className="card">
          <div class="w-[605px] h-20 my-2 mx-3 justify-start items-center gap-10 inline-flex">
            <div
              onClick={() => {
                setReel(!isReelSelected);
              }}
              class={`w-[175px] h-20 px-4 py-3 cursor-pointer ${
                isReelSelected ? "bg-blue-600" : "bg-indigo-300"
              } rounded-[10px] justify-center items-center gap-[18px] flex`}
            >
              <div class="w-[26px] h-[26px] relative">
                <img src={Reel} alt="" />
              </div>
              <div class="text-center text-white text-sm font-semibold font-['Open Sans'] leading-[17.50px]">
                {`${isReelSelected ? 1 : 0} x Reel`}
              </div>
            </div>
            <div
              onClick={() => {
                setImage(!isImageSelected);
              }}
              class={`w-[175px] h-20 px-4 py-3 cursor-pointer ${
                isImageSelected ? "bg-blue-600" : "bg-indigo-300"
              } rounded-[10px] justify-center items-center gap-[18px] flex`}
            >
              <div class="w-[26px] h-[26px] relative">
                <img src={Vector} alt="" />
              ...
              <div class="text-center text-white text-sm font-semibold font-['Open Sans'] leading-[17.50px]">
                {`${isImageSelected ? 1 : 0} x Image`}
              </div>
            </div>
            <div
              onClick={() => {
                setStory(!isStorySelected);
              }}
              class={`w-[175px] h-20 px-4 py-3 cursor-pointer ${
                isStorySelected ? "bg-blue-600" : "bg-indigo-300"
              } rounded-[10px] justify-center items-center gap-[18px] flex`}
            >
              <div class="w-[26px] h-[26px] relative">
                <img src={Video} alt="" />
        ...
        <div className="offering">
          ...
          <div className="card" class="mx-4">
            <div class="w-[400px] h-40 justify-start items-center gap-10 inline-flex">
              <div
                ...
                class={`w-[180px] h-40 px-4 py-3 cursor-pointer ${
                  offering == "PAYMENT"
                    ? "bg-indigo-50 border border-indigo-600"
                    : "bg-neutral-100"
                } rounded-[10px] flex-col justify-center items-center gap-2 inline-flex`}
              >
            ...
            <div className="pills" class="my-3 mx-4">
              <div class="w-[398px] h-10 justify-start items-center gap-10 inline-flex">
                <div
                  ...
                  class={`grow shrink basis-0 h-10 px-6 cursor-pointer rounded-lg ${
                    paymentType == "FIXED"
                ...
                >
                  <div
                    class={`w-[18px] h-[18px] ${
                      paymentType == "FIXED" ? "bg-indigo-600" : "bg-zinc-400"
                    } rounded-full`}
                  ></div>
              ...
              <div className="amount" class="mx-2 my-6">
                <div class="w-[641.77px] h-[48.19px] justify-start items-center gap-[11px] inline-flex">
                  <div class="w-[301.35px] h-12 px-6 rounded-lg border border-neutral-700 justify-start items-center gap-3 flex">
                    ...
                    <input
                      type="Number"
                      class=" outline-0 text-center text-zinc-500 text-base font-normal font-['Open Sans'] leading-tight"
              ...
              <div className="low " class="mx-2">
                <div class="w-[266.62px] h-[18.15px] justify-start items-center gap-2 inline-flex">
                  ...
                  <div class="text-center">
                    ...
                    <span class="text-red-500 text-sm  cursor-pointer  font-bold font-['Open Sans'] underline leading-[17.50px]">
                      Add now
                    </span>
                  </div>
                </div>
          ...
          <div className="buttons inline-flex mx-2 my-4">
            <div class="w-[180px] h-10 px-4 rounded border border-indigo-600 cursor-pointer justify-center items-center gap-2 inline-flex">
            ...
            <div className="btn mx-60 gap-4 inline-flex">
              <div class="w-[180px] h-10 px-4 bg-indigo-600 rounded cursor-pointer justify-center items-center gap-2 inline-flex ">
                <div class="text-center text-white text-base font-normal font-['Open Sans'] leading-none mx-10">
                  Save
                </div>
              </div>
              <div  class="w-[214px] h-10 px-4 bg-indigo-600 rounded cursor-pointer justify-center items-center gap-2 inline-flex">
